...
public class Constants {
  ...
  public static final String PERMISSION_ERROR_CREATE = "Error creating permission: %s";
  public static final String PERMISSION_ERROR_NOT_FOUND = "Permission not found with index: %d";

...
public class ClientsAPI extends BaseController<Client> {
	...
	public Client update(@Named("id") Long id, Client data, User user) throws NotFoundException, InternalServerErrorException, UnauthorizedException {
		validateUser(user);
		Client client = null;
		try {
			client = Client.getById(id);
	...
	@Override
	@ApiMethod(httpMethod = ApiMethod.HttpMethod.DELETE, name = "client.delete", path = "client/{id}")
	public Client delete(@Named("id") Long id, User user) throws NotFoundException, InternalServerErrorException, UnauthorizedException {
		validateUser(user);
		Client client = null;
		try {
			client = Client.getById(id);
	...
	@Override
	@ApiMethod(httpMethod = ApiMethod.HttpMethod.GET, name = "client.list", path = "clients")

...
/**
 * Base for will controllers that declares a group of methods for CRUDL
 * Created by plessmann on 02/06/16.
 *
 * @param <T>   type that extends BaseModel, it defines the elements to be managed by the CRUDL methods
 */
@ApiClass(

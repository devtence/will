 ...
 * <p>
 * Every class that extends from this will use the UserAuthenticator class as default authenticator.
...
public abstract class BaseController<T extends BaseModel> {
     ...
     * @throws NotFoundException    the instance related to the id doesnt exists in the persistence unit
     * @throws InternalServerErrorException a generic error ocurred that is not related to the input
     * @throws UnauthorizedException    the user parameter did not pass the authentication test
     */
    ...
    /**
     * Base method to update an entity of type T that exists in the persistence unit.
     *
    ...
    /**
     * Base method to delete an entity that exists in the persistence unit.
     *
     * @param id    id of the required instance of type T
     * @param user  user provided by authentication to restrict access to this operation
     ...
     *
     * @param user  user instantiated by the authenticator

...
public class NotificationsAPITest {
	...
	public void list() throws Exception {
		...
		sender = "1test@test.test";
		recipients = "1test@test.test;2test@test.test;3test@test.test";
		subject = "Test";
